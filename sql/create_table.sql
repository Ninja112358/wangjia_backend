...
create table if not exists room(
    ...
    roomState       varchar(256)                                null comment '房间状态:0：正常，1：有客，2：维修，3：空打扫，4.住宿打扫，5.锁房',
    ...
    isWindow        boolean default false                       null comment '房间是否带窗',
...
(
    ...
    name            varchar(200)                                comment '顾客名称',
    phone           varchar(20)                                 comment '联系电话',
    IDCard          varchar(20)                                 comment '顾客身份证号',
    cardType        varchar(20)                                 comment '证件类型',
    pay             decimal(10,2)                               comment '付款金额',
    restMoney       decimal(10,2)                               comment '剩余金额',
    consume         decimal(10,2)                               comment '消费金额',
    roomId          varchar(20)                                 comment '房间id',
    roomType        varchar(20)                                 comment '房间类型',
    roomPrice       decimal(10,2)                               comment '房间价格',
    orderGroupId    bigint                                      null comment '订单组的id',
    customType      int                                         comment '顾客类型(0散客,1团队)',
    info            varchar(1000)                               comment '订单备注信息',
    orderState      int             default 0                   comment '订单状态(0未结,1已结)',
