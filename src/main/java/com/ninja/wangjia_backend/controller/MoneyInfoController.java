...
//    //联房
//    //联房思路:本质是多个orderGroup进行联房
//    @PostMapping("/order/contact")
//    @AuthCheck(mustRole = "user")
//    public BaseResponse<Boolean> contactOrder(@RequestBody List<Long> orderIdList) {
//        return ResultUtils.success(moneyInfoService.contactOrder(orderIdList));
//    }
}
