...
import com.ninja.wangjia_backend.mapper.UserMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        ThrowUtils.throwIf(userPassword.length() < 6 || checkPassword.length() < 6, ErrorCode.PARAMS_ERROR, "用户密码长度不能小于6");
    ...
    public String getEncryptPassword(String userPassword) {
        // 加盐,混淆密码
        final String SALT = UserConstant.ENCRYPTION_SALT;
    ...
    public QueryWrapper<User> getQueryWrapper(UserQueryRequest userQueryRequest) {
        ...
        if(!userRole.equals("all")){
            if(userRole.equals("fuck")){
                queryWrapper.ne(ObjUtil.isNotNull(userRole), "userRole", UserRoleEnum.ADMIN.getValue());
                queryWrapper.ne(ObjUtil.isNotNull(userRole), "userRole", UserRoleEnum.USER.getValue());
            }else
